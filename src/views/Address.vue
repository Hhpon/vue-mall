            ...
            <div class="addr-list">
              <ul>
                <li
                  ...
                  @click="checkIndex=index;selectedAddreid=item.addressId"
                  :key="index"
                >
                  <dl>
                    <dt>{{item.userName}}</dt>
  ...
  data() {
    ...
    return {
      ...
      rules2: {
        ...
        tel: [{ validator: validatetel, trigger: "blur,change" }],
        postCode: [{ validator: validatepost, trigger: "blur,change" }],
        streetName: [{ validator: validatestreet, trigger: "blur,change" }]
      }
    };
  },
  components: {
  ...
  methods: {
    ...
    btnNext() {
      if (this.addressList.length == 0) {
        ...
        this.$router.push({
          path:
            "/orderConfirm?addressId=" +
            this.selectedAddreid +
            "&shopid=" +
